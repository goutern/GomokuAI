    ...
    def is_win(self, row, col, board, maximizingPlayer):
        ...
        if maximizingPlayer:
            if board.is_win_for(self.checker, row, col):
                return 9999
            numbers, is_open = self.check_open4(self.checker, row, col)
            if numbers and is_open:
                return numbers
            numbers, is_open = self.check_double_open3(self.checker, row, col)
            if numbers and is_open:
                return numbers
            return 0
